...
export default async function CategoryPage({ params }) {
  ...
  return (
    <div className="overflow-x-hidden bg-[#e8e8e8] min-h-screen flex flex-col">
        ...
        <div
        className="text-[12px] flex items-center justify-start w-full cabin text-black  px-2 md:px-6    mb-2     border-gray-800 pb-2"
        >
    ...
    <div className="">
      ...
      {products.length === 0 ? (
       ...
       <div className="grid grid-cols-2 gap-x-4 gap-y-6 py-6 mb-5 px-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-full">
  {products.map((p) => (
