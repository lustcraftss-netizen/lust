...
import bondage from "../../../public/images/beltstraps/bondage_belt.png";
import slave from "../../../public/images/beltstraps/slave_strap.png";
import thigh from "../../../public/images/beltstraps/thigh_cuff.jpg";
import Link from "next/link";

export default function BeltStraps() {
  return (
    <div className="bg-black overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 w-full max-w-7xl mx-auto px-2 py-4 gap-y-6 md:gap-y-2 md:gap-x-4">
        ...
        >
          <p className="text-white">Belts</p>
          <p className="text-white">&</p>
          <p className="text-white">Straps</p>
        </motion.div>
        ...
        >
          ...
          >
            <p className="text-white text-[35px] md:text-[25px]">Bondage belts</p>
            <Link href="/categories/bondage-belts">
        ...
        >
          ...
          <div className="p-2 text-center cinzel md:text-left">
            <p className="text-white text-[35px] md:text-[25px]">Slave belts</p>
            <Link href="/categories/slave-belts">
              <button className="bg-white text-black font-semibold p-2 mt-2">
                See Collection
              </button>
            </Link>
        ...
        >
          ...
          />
          <div className="p-2 text-center cinzel md:text-left">
            <p className="text-white text-[35px] md:text-[25px]">Thigh cuff</p>
            <Link href="/categories/thigh-cuff">
